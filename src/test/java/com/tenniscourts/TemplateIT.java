...
@SpringBootTest(
	classes = TennisCourtApplication.class,
...
public abstract class TemplateIT {
	...
	@Before
	public final void templateSetUp()
		throws Exception {
	...
	protected final ResultMatcher contentJSONLenient(
		final String expectedJSON) {
		return MockMvcResultMatchers.content().json(expectedJSON, false);
	}
	...
	protected final ResultMatcher content(
		final String expectedJSON) {
		return MockMvcResultMatchers.content().string(expectedJSON);
	}
