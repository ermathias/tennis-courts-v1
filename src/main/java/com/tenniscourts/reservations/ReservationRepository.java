...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query("select reservation from Reservation reservation join reservation.schedule as schedule where schedule.endDateTime <:date")
    List<Reservation> findAllPastReservations(@Param("date") LocalDateTime date);
